...
//
//  Created by Diego Henrique Silva Oliveira on 12/04/21.
//
                    ...
                    Image(uiImage: #imageLiteral(resourceName: "Memory.png"))
                        ...
                        .onAppear {
                            ...
                            DispatchQueue.main.asyncAfter(deadline: .now()+7) {
                                PlaygroundPage.current.assessmentStatus = .pass(message: "Let's start!")
                                PlaygroundPage.current.navigateTo(page: .pageReference(reference: "Fixed Partitioning"))
                            }
                        }
                }
